...
const Schema: z.ZodType<Prisma.VisitCreateNestedManyWithoutRestaurantInput> = z
  .object({
    create: z
      .union([
...
export const VisitCreateNestedManyWithoutRestaurantInputObjectSchema = Schema
