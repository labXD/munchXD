...
const Schema: z.ZodType<Prisma.ReminderUncheckedCreateNestedManyWithoutRestaurantInput> =
  z
    .object({
      create: z
        .union([
...
export const ReminderUncheckedCreateNestedManyWithoutRestaurantInputObjectSchema =
  Schema
