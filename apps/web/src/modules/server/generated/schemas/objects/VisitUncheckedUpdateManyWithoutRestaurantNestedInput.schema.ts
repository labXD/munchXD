...
const Schema: z.ZodType<Prisma.VisitUncheckedUpdateManyWithoutRestaurantNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const VisitUncheckedUpdateManyWithoutRestaurantNestedInputObjectSchema =
  Schema
