...
const Schema: z.ZodType<Prisma.ReminderUpdateManyWithoutRestaurantNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ReminderUpdateManyWithoutRestaurantNestedInputObjectSchema = Schema
